...
- If the user has submitted on the practice page as well as participated in a contest then send an email with the text: https://discuss.codechef.com so that they may discuss with other members of the community.
...
### Output Format
- Print one of the following strings as per the problem statement. https://www.codechef.com/practice https://www.codechef.com/contests https://discuss.codechef.com
### Constraints
- $A$ is either $0$ or $1$.
- $B$ is either $0$ or $1$.
### Sample 1:
...
**Runtime:** N/A  
**Memory:** N/A  
**Submitted:** 2026-07-21T12:09:59.175Z  
...
[View on CodeChef](https://www.codechef.com/problems/CHEFPAGES)